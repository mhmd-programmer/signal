    ...
    <div>
        ...
        <div class="panel">
            ...
            <form @submit.prevent="Submit">
                ...
                <div class="form-group">
                    <button v-if="f" style="background:white;color:green;border:1px solid green" class="btn" v-ripple>ارسال</button>
                    <button v-if="e" style="background:white;color:green;border:1px solid green" class="btn" v-ripple>Send</button>
                </div><br>
                <center>
