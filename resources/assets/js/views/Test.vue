            ...
            <div class="container">
                <div class="row archive-chart">
                    <div class="col-md-12" style="background:rgba(7, 71, 105,0.7);border-radius:10px; text-align:center">
                      <div class="spinner-border chart-load text-danger" role="status" v-if="loading">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card2">
                      ...
                      <div class="content">
                        ...
                        <div>
                                <button style="color:#fff;position:absolute;bottom:10px;left:15px;border-radius:20px;background:none;padding:4px;font-size:12px;margin-bottom:8px;border:1px solid #fff">ViewChart</button>
                                <button class="open-box" style="color:#fff;position:absolute;bottom:10px;right:15px;border-radius:20px;background:none;padding:4px;font-size:12px;margin-bottom:8px;border:1px solid #fff">SignaloBegir:)</button>
                            </div>
                    </div>
                  </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12" v-for="signal in signals">
                    <div class="card2">
                      ...
                      <div class="content">
                        ...
                        <div>
                                <button style="color:#fff;position:absolute;bottom:10px;left:15px;border-radius:20px;background:none;padding:4px;font-size:12px;margin-bottom:8px;border:1px solid #fff">ViewChart</button>
                                <button @click="OpenSignal(signal.id, signal.status)" style="color:#fff;position:absolute;bottom:10px;right:15px;border-radius:20px;background:none;padding:4px;font-size:12px;margin-bottom:8px;border:1px solid #fff">SignaloBegir:)</button>
                            </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row archive-gold">
            ...
            <div class="card-image-container">
                <img src="/img/dmitry-demidko-z4VuRg-ZOEg-unsplash.jpg" class="card-image img-gold">
            </div>
            <svg class="card-svg" viewBox="0 0 800 500">
                <path d="M 0 100 Q 50 200 100 250 Q 250 400 350 300 C 400 250 550 150 650 300 Q 750 450 800 400 L 800 500 L 0 500" stroke="transparent" fill="#333"/>
                <path class="card-line" d="M 0 100 Q 50 200 100 250 Q 250 400 350 300 C 400 250 550 150 650 300 Q 750 450 800 400" stroke="pink" stroke-width="3" fill="transparent"/>

            </svg>
            <input type="checkbox" id="fa-signal">
            <div class="card-content">
                <h1 class="card-title">XAU / USD</h1>
                <input type="checkbox" id="fa-signal">
                <label class="fas fa-signal"  for="fa-signal"></label>
            </div>
        </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
              <div class="card">
            <div class="card-image-container">
                <img src="/img/gold cart.jpg" class="card-image img-gold">
            </div>
            <svg class="card-svg" viewBox="0 0 800 500">
                <path d="M 0 100 Q 50 200 100 250 Q 250 400 350 300 C 400 250 550 150 650 300 Q 750 450 800 400 L 800 500 L 0 500" stroke="transparent" fill="#333"/>
                <path class="card-line" d="M 0 100 Q 50 200 100 250 Q 250 400 350 300 C 400 250 550 150 650 300 Q 750 450 800 400" stroke="pink" stroke-width="3" fill="transparent"/>
