    ...
    <div>
        <div class="change-pass">
            ...
            <form @submit.prevent="Password">
                ...
                <button v-if="f" class="btn" style="background:green;color:white" v-ripple>تغییر کلمه عبور</button>
                <button v-if="e" class="btn" style="background:green;color:white" v-ripple>change</button>
            </form>
        </div>
        ...
        <center>
            ...
            <p v-if="f" style="color:grey;border-bottom: 1px dashed;display:table;padding-bottom:5px">تنضیمات</p>
            <p v-if="e" style="color:grey;border-bottom: 1px dashed;display:table;padding-bottom:5px">settings</p><br>
        </center>
        <div class="container">
            <div class="sett-desktop">
                <form @submit.prevent="Change">
                    <div style="width:1px;height:60%;background:grey;position:absolute;left:50%"></div>
            ...
            <div class="row" dir="rtl" style="margin-right:250px">
                <div class="col-lg-3">                  
                        <div class="form-group">
                            <v-text-field :label="g" name="email" v-model="email"></v-text-field>
                        </div>
                </div>
            </div>
            <div class="row" style="margin-left:250px">
                <div class="col-lg-3" style="text-align:center">                  
                        <span v-if="f" @click="Open" class="btn" style="background:yellow" v-ripple>تغییر کلمه عبور</span>
                        <span v-if="e" @click="Open" class="btn" style="background:yellow" v-ripple>change password</span>
                </div>
            </div>
            <div class="row" dir="rtl" style="margin-right:250px">
                <div class="col-lg-3">                  
            ...
            <br>
            <br>
            <center><button v-if="f" class="btn" style="background:green;color:white" v-ripple>تغییر اطلاعات</button></center>
            <center><button v-if="e" class="btn" style="background:green;color:white" v-ripple>change</button></center>
                </form>
            </div>
            <div class="sett-mobile">
                <form action="">
                    <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                        ...
                        <div class="form-grou">
                            <center><span v-if="f" @click="Open" class="btn" style="background:yellow" v-ripple>تغییر کلمه عبور</span></center>
                            <center><span v-if="e" @click="Open" class="btn" style="background:yellow" v-ripple>change password</span></center>
                        </div><br>
                        <div class="form-group">
                            <center><button v-if="f" class="btn" style="background:green;color:white" v-ripple>تغییر اطلاعات</button></center>
                            <center><button v-if="e" class="btn" style="background:green;color:white" v-ripple>submit</button></center>
                        </div>
                    </div>
                </div>
                </form>
